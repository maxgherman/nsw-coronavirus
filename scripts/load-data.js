...
const arrangeByDate = (data, store) =>
...
const run = async (baseDir) => {
    ...
    const cases = await mergeCases(
        ...
        'https://raw.githubusercontent.com/maxgherman/nsw-corona-virus/gh-pages/cases-total.json',
    ...
    const resultTests = await mergeTests(
        ...
        'https://raw.githubusercontent.com/maxgherman/nsw-corona-virus/gh-pages/tests-total.json',
    )
